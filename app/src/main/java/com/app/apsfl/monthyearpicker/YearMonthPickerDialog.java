...
public class YearMonthPickerDialog implements Dialog.OnClickListener {
    ...
    private void build() {
        ...
        mDialogBuilder.setTitle("Select Month and Year");
    ...
    private static String[] monthsList() {
        if (MONTHS_LIST == null) {
            ...
            stringMonths[0] = "January";
            stringMonths[1] = "February";
            stringMonths[2] = "March";
            stringMonths[3] = "April";
            stringMonths[4] = "May";
            stringMonths[5] = "June";
            stringMonths[6] = "July";
            stringMonths[7] = "August";
            stringMonths[8] = "September";
            stringMonths[9] = "October";
            stringMonths[10] = "November";
            stringMonths[11] = "December";
