...
public class FailedForms extends AppCompatActivity
        implements ListSelectionInterface, ResponseHandler, UserActionInterface {

    private final String TAG = "FailedFormsActivity";
    ...
    private void loadOfflineFormData() {
        ...
        offlineFormList.addAll(realm.where(SIOfflineFormModel.class)
                .beginGroup()
                .equalTo("isFormUploaded", false).equalTo("isNetworkAvailble",true)
                .endGroup()
