...
/**
 * Created by Arbiva on 1/9/2017.
 */

public class IptvPackageSpinnerAdapter extends BaseAdapter {

    private LayoutInflater inflater;
    private RealmList<ProductModel> data;

    public IptvPackageSpinnerAdapter(Context context,RealmList<ProductModel> data) {
    ...
    public View inflateView(int position,  int layoutResource, ViewGroup parent){
        ...
        spinnerText.setText(data.get(position).getProductName());
        return convertView;
    }
