...
public class OLTIDSpinnerAdapter extends BaseAdapter {

    private LayoutInflater inflater;
    private RealmList<POPOLTModel> data;

    public OLTIDSpinnerAdapter(Context context, RealmList<POPOLTModel> data) {
    ...
    public View inflateView(int position, int layoutResource, ViewGroup parent) {
        ...
        spinnerText.setText(data.get(position).getPopLabelNumber());
        return convertView;
    }
}