...
public class CPEModelSpinnerAdapter extends BaseAdapter {

    private LayoutInflater inflater;
    private RealmList<CPEDataModel> data;

    public CPEModelSpinnerAdapter(Context context, RealmList<CPEDataModel> data) {
    ...
    public View inflateView(int position, int layoutResource, ViewGroup parent) {
        ...
        spinnerText.setText(data.get(position).getCpeModelName());
        return convertView;
    }
}